...
?>
<div class="fanc-row">
    <label for="wpl_o_video_width"><?php echo __('Video width', 'real-estate-listing-realtyna-wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_video_height"><?php echo __('Video height', 'real-estate-listing-realtyna-wpl'); ?></label>
