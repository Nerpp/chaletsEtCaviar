...
function wpl_send_user_contact<?php echo $this->activity_id; ?>(user_id)
{
    ...
    {
        wpl_show_messages("<?php echo addslashes(__('Error Occurred!', 'real-estate-listing-realtyna-wpl')); ?>", '#wpl_user_contact_message<?php echo $this->activity_id; ?>_'+user_id, 'wpl_red_msg');
    });
