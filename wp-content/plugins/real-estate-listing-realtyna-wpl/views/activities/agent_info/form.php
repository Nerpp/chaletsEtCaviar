...
?>
<div class="fanc-row">
    <label for="wpl_o_picture_width"><?php echo __('Picture width', 'real-estate-listing-realtyna-wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_picture_height"><?php echo __('Picture height', 'real-estate-listing-realtyna-wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_mailto"><?php echo __('Mailto:', 'real-estate-listing-realtyna-wpl'); ?></label>
    ...
    <span class="gray_tip"><?php echo __('Sending emails directly', 'real-estate-listing-realtyna-wpl'); ?></span>
</div>