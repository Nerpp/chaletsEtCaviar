...
<div class="fanc-row">
    <label for="wpl_o_outer_margin"><?php echo __('Outer margin', 'real-estate-listing-realtyna-wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_size"><?php echo __('Size', 'real-estate-listing-realtyna-wpl'); ?></label>
