...
<div class="fanc-content size-width-1">
    <h2><?php echo (isset($this->listing_type_data->name) ? $this->listing_type_data->name : __('Add new listing type', 'real-estate-listing-realtyna-wpl')); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="wpl_title<?php echo $this->listing_type_id; ?>"><?php echo __('Name', 'real-estate-listing-realtyna-wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label for="wpl_parent<?php echo $this->listing_type_id; ?>"><?php echo __('Category', 'real-estate-listing-realtyna-wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label for="wpl_gicon<?php echo $this->listing_type_id; ?>"><?php echo __('Google Icon', 'real-estate-listing-realtyna-wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label></label><input type="button" class="wpl-button button-1" onclick="wpl_ajax_insert_listing_type(<?php echo $this->listing_type_id; ?>);" value="<?php echo __('Save', 'real-estate-listing-realtyna-wpl'); ?>"/>
        </div>
        <?php } ?>
        <div class="fanc-row">
        </div>
