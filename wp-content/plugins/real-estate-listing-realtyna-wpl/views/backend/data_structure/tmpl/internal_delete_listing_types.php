...
<div class="fanc-content size-width-1" id="wpl_delete_listing_property_type_cnt">
    <h2><?php echo __('Removing listing type', 'real-estate-listing-realtyna-wpl') . ' ' . __($this->listing_type_data->name, 'real-estate-listing-realtyna-wpl'); ?></h2>
    ...
    <div class="fanc-body wpl-del-options" id="lt-del-options">
        ...
        <div onclick="show_opt_2_listing_type()" id="option_2" class="button button-primary button-large wpl-assign">
            <?php echo __('Assign to another listing type', 'real-estate-listing-realtyna-wpl'); ?>
        </div>
    </div>

    <div class="fanc-body hidden" id="lt-del-plist">
        <div class="fanc-row fanc-button-row-2">
            <input type="button" class="wpl-button button-1" value="<?php echo __('Assign', 'real-estate-listing-realtyna-wpl'); ?>" onclick="assign_properties_listing_type(<?php echo $this->listing_type_id; ?>);" />
        </div>
        <div class="fanc-row">
            <label for="listing_type_select"><?php echo __('Listing Type', 'real-estate-listing-realtyna-wpl'); ?></label>
