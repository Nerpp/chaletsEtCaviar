...
<div class="fanc-body">
	<div class="fanc-row fanc-button-row-2">
        ...
        <?php if($dbst_id and (wpl_global::check_addon('mls') or wpl_global::check_addon('importer')) and $dbst_id >= 3000): ?><input class="wpl-button button-2" type="button" onclick="convert_dbst('<?php echo $__prefix; ?>', <?php echo $dbst_id; ?>, 'select');" value="<?php echo __('Convert to Select', 'real-estate-listing-realtyna-wpl'); ?>" id="wpl_dbst_convert_button" /><?php endif; ?>
