...
class wpl_notifications
{
    ...
    {
        wpl_file::write(self::get_template_path($data['template_path']), stripslashes($data['template']));
        ...
        $query .= "`additional_emails` = '{$data['include_email']}',`additional_memberships` = '{$data['include_membership']}',`additional_users` = '{$data['include_user']}',`subject` = '{$data['subject']}' ".$sms_query;
