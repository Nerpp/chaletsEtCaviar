                        ...
                        <div class="wpl-lang-cnt" id="wpl_langs_cnt_<?php echo $field->id; ?>_<?php echo strtolower($wpllang); ?>">
                            ...
                            <?php if(isset($options['advanced_editor']) and $options['advanced_editor'] and wpl_global::check_addon('pro')): ?>
                                ...
                                <input class="wpl-button button-1 wpl-multiling-save-pro"
                                       ...
                                       value="<?php echo __('Save', 'real-estate-listing-realtyna-wpl'); ?>" />
...
<?php else: ?>
    ...
    <input class="wpl-button button-1 wpl-save-btn" type="button" onclick="ajax_save('<?php echo $field->table_name; ?>', '<?php echo $field->table_column; ?>', wpl_get_tinymce_content('tinymce_wpl_c_<?php echo $field->id; ?>'), '<?php echo $item_id; ?>', '<?php echo $field->id; ?>');" value="<?php echo __('Save', 'real-estate-listing-realtyna-wpl'); ?>" />
    <?php else: ?>
